...
function createField(label, idInput, container) {
...
// ===============================================================
function createResultField(label, idInput) {
...
// ===============================================================
function createButtonElement(className, name) {
...
class CurrencyConverter {
    ...
    createUi() {
        ...
        this.container.append(uahField.wrapper, this.convertBtn, euroField.wrapper, dollarField.wrapper);
    }
...
// =================================================
function generateInputField(label, idInput, disabled) {
...
// ==================================================
function generateButtonCalculateAge(title, className) {
