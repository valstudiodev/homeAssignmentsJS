...
function regexIncludeNumber(arr) {
    const regex = /\d/;
    const result = [];
...
function regexStrWitthoutNumbers(arr) {
    const regex = /\d/;
...
function getWordsWithoutVowels(arr) {
    const regex = /[aeiou]/i;
    return arr.filter(str => !regex.test(str));
}
...
function getStringsIncludes1or3(arr) {
    const regex = /[13]/;
    return arr.filter(str => regex.test(str));
}
...
const text1 = 'I bought 15 apples, 7 bananas and 125 oranges in 2026';
function showAllNumbersInTheString(str) {
    const regex = /\d+/g;
...
const text2 = "Hello, world! How are you? I am fine... really; thanks.";
...
const text3 = "My birthday is 12.05.2001";
const text4 = "Today is 2026-06-15";
const text5 = "No date here";
...
const text6 = "I have 12 apples, 7 bananas, 45 oranges and 100 grapes";
const text7 = "No numbers here";
const text8 = "10 20 3 456 78";
function getTwoDigitNumbers(text) {
...
const text9 = ` My cards: 4142-3433-2323-3434 5555444433332222 1234-5678 999999999999999 `;
function getNumberOfBankCard(str) {
    const regex = /\b\d{4}-\d{4}-\d{4}-\d{4}\b|\b\d{16}\b/g;
    return str.match(regex) ?? [];
}
...
const text10 = "Events happened in 2019, 2020, 2023, 2049, 2050 and 1999 and 2035";
function getYearsBetween2020And2049(str) {
...
function getNumberOfKyivstar(phone) {
    const regex = /^\+380(67|68|96|97|98)/;
...
function getDateInFormatMonthAndYear(date) {
