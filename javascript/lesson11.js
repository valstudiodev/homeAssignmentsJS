...
function getHalfOfMatrix(matrix) {
    return matrix.length / 2;
}
const half = getHalfOfMatrix(matrixSquare);
function getRangeIndexes(matrix, rowStart, rowEnd, colStart, colEnd) {
    let sum = 0;
...
function getCheckerboardSum(arr) {
    let sumOddColInEvenRows = 0;
    let sumEvenColInOddRows = 0;
    for (let row = 0; row < arr.length; row++) {
        for (let col = 0; col < arr[row].length; col++) {
...
function getSumFromArrStoreProfitData(arr) {
    let sum = [];
...
function getTotalIncomeByDays(arr, daysCount = 5) {
    const incomes = [];
...
function getWeeklyProfit(prices, limit = 5) {
...
function getWeekendsProfit(prices) {
...
function getIncomeForWednesday(prices) {
    let sumWednesday = 0;
    for (let week = 0; week < prices.length; week++) {
...
function getArrWithValuesMoreThan200(arr) {
...
function sortedValuesByIncrease(arr) {
...
// ===============================================================================================
// ===============================================================================================
function createEmptyField(rowCount = 6, colCount = 6) {
    const field = [];
...
function placeShipsRandomly(rowCount, colCount, shipCount) {
...
function processGame(rowCount, colCount, shipCount, bulletsCount) {
