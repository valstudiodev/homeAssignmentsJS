"use strict";
function createTitle(title, className) {
...
// =================================================================================================
const titleTask1 = createTitle('Task 1', 'title-1');
const boxTask1 = document.querySelector(`.task-1`);
if (boxTask1) {
    boxTask1?.before(titleTask1);
}
function generateRange(title, className, value) {
...
function generateStudentDashboard(students) {
...
// =================================================================================================
const titlePage2 = createTitle('Task 2', 'title-2');
const boxTask2 = document.querySelector(`.task-2`);
if (boxTask2) {
    boxTask2?.before(titlePage2);
}
function createLoader(title, className) {
    const wrap = document.createElement('div');
    wrap.className = `${className}__wrap`;
    wrap.style.display = 'flex';
...
function updateLoader(loaderObject, speed) {
...
// =================================================================================================
const titlePage3 = createTitle('Task 3', 'title-3');
const boxTask3 = document.querySelector(`.task-3`);
if (boxTask3) {
...
class LoginForm {
    ...
    #createInputField(labelText, inputType, placeholderText) {
        const wrap = document.createElement('div');
        wrap.style.display = 'flex';
        wrap.style.alignItems = 'center';
        wrap.style.gap = '10px';
...
// =================================================================================================
const titlePage4 = createTitle('Task 4', 'title-4');
const boxTask4 = document.querySelector(`.task-4`);
...
function renderBouncingObject(amount, title) {
...
// =================================================================================================
const titlePage5 = createTitle('Task 5', 'title-5');
const boxTask5 = document.querySelector(`.task-5`);
if (boxTask5) {
...
function createProductCard(className, text) {
...
function createQuantityInput(className) {
    const wrap = document.createElement('div');
    wrap.style.display = 'flex';
    wrap.style.alignItems = 'center';
    wrap.style.gap = '5px';
...
function renderTotalCartPrice(inputField, basePrice = 45) {
    if (!boxTask5)
        return;
    let totalCartBlock = boxTask5.querySelector('.cart-price');
    if (!totalCartBlock) {
...
function updateTotalPrice(inputField, basePrice, btnMinus, btnPlus) {
    let minCount = 1;
    let maxCount = 10;
...
// =================================================================================================
const titlePage6 = createTitle('Task 6', 'title-6');
const boxTask6 = document.querySelector(`.task-6`);
if (boxTask6) {
...
class Product {
    ...
    createCardElement(className, title) {
