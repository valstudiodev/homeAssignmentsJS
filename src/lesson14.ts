...
// ================================
function getTotalPriceSites(arr: WebsiteType[]) {
...
function runMain(data: WebsiteType[]) {
  // ============= 1 =============
...
function getYearInN(date: UserDataType, N: number): number {
...
function initMain(data: DataListType[]) {
  // =========== 1 ============
