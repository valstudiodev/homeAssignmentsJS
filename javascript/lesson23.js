...
function getVisitsUsers(visits) {
    const mapVisits = new Map();
...
function renderInfoUsersVisits() {
...
function getCountFaculty(students) {
...
let temperatures = [12.4, 24.9, 10.6, 12.4, 24.9, 12.4, 10.6, 11.9];
function getTempratures(arrTemp) {
    const map = new Map();
...
function getUnionStudents(groupA, groupB) {
