...
function getDancePairs(boys: string[], girls: string[], boyIndex: number = 0): string[][] {
...
// ========================================================================================
function visitWebsite(): void {
  const isUserAgreed: boolean = confirm('Would you like to visit a web-site?')
  if (isUserAgreed) {
