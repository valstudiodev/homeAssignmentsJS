...
function coctailSortSwitch(arr: number[]): void {
  let changed
  let leftIndex = 0
  let rightIndex = arr.length - 1
  let countChanged = 0
...
function insertationSortSwitch(arr: number[]): void {
  let countChanged = 0
...
// ============= function draw table ===========
function drawTable(arr: number[], title: string): void {
...
function bubbleSortTable(arr: number[]): void {
  let changed
  let rightIndex = arr.length - 1
  let countChanged = 0
  let step = 1
...
function coctailSort(arr: number[]): void {
  let changed
  let leftIndex = 0
  let rightIndex = arr.length - 1
  let step = 1
...
function insertationSort(arr: number[]): void {
  let countChanged = 0
  let step = 1
...
let names: string[] = ['Ivan', 'Petr', 'Andrew', 'Oleg', 'Olga', 'Maria', 'Marina'];

function insertationSortAlphabet(arr: string[]): string[] {
  for (let k = 1; k < arr.length; k++) {
    const current = arr[k]
    let i = k - 1
...
function binarySearch(arr: string[], searchElement: string, start: number, end: number) {
  // if (start <= end) {
...
let namesArr: string[] = ['Ivan', 'Petr', 'Andrew', 'Ina', 'Jonh', 'Oleg', 'Olga', 'Maria', 'Marina'];

function insertationSortLength(arr: string[]): string[] {
  for (let k = 1; k < arr.length; k++) {
    const current = arr[k]
...
function binarySearchLongestName(arr: string[], searchElement: number): number {
  let start = 0
  ...
  while (start <= end) {
    ...
    if (middleLength === searchElement) return middle
    if (middleLength < searchElement) start = middle + 1
    else end = middle - 1
  }
  return -1
}
